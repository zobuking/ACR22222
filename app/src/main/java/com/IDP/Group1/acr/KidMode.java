...
public class KidMode extends Fragment implements View.OnTouchListener, View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        /*sonar_mostleft_ref.addValueEventListener(this);
        sonar_left_ref.addValueEventListener(this);
        sonar_mid_ref.addValueEventListener(this);
        sonar_right_ref.addValueEventListener(this);
        sonar_right_ref.addValueEventListener(this);*/

        //sonar_ref.addValueEventListener();
        ...
        //sonar_ref.addValueEventListener(postListener);
